...
class Conv2dClassifier(nn.Module):
    def __init__(self, c_in=1, num_classes=7):
        ...
        # 48x48x1
        self.conv1 = ConvBlock(c_in, 64, kernel_size=5, stride=1, padding=2)
        self.max_pool = MaxPool2d(kernel_size=2, stride=2)
        # 48x48x64
        self.conv2 = ConvBlock(64, 64, kernel_size=5, stride=1, padding=2)
        self.max_pool = MaxPool2d(kernel_size=2, stride=2)
        # 24x24x64
        self.conv3 = ConvBlock(64, 64, kernel_size=5, stride=1, padding=2)
        self.max_pool = MaxPool2d(kernel_size=2, stride=2)
        # 12x12x64
        self.conv4 = ConvBlock(64, 64, kernel_size=5, stride=1, padding=2)
        # 6x6x64
